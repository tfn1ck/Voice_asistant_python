...
def conditions():
    ...
    if 'wikipedia' in query:
            ...
            speak("good morning sir. It is a great day.")
    elif 'good night' in query:
            speak('good night')
            exit(0)
    elif 'too hot' in query:
            speak('its really hot outside. tho im just an ai')
    elif 'too cold' in query:
            speak('its really cold outside. tho im just an ai')
    elif 'raining' in query:
            speak('its really raining good outside. tho im just an ai')
    elif 'spring' in query:
            speak('ah spring is here. that means another year is coming soon')
            ...
            speak('its my work to help you out')
    elif 'good' in query:
            speak('thank you')
